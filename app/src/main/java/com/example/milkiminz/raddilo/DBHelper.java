...
public class DBHelper extends ContentProvider {
    private static final String PROVIDER_NAME = "com.example.milkiminz.raddilo.DBHelper";
    private static final String URL = "content://" + PROVIDER_NAME + "/persons";
    ...
    private static final String PERSONS_TABLE_NAME = "users";
